...
o	3-axial linear acceleration 
o	3-axial angular velocity 
...
o	t = Time  - at the start of a variable name
o	f = Frequency - at the start of a variable name
o	Acc = Accelerometer
o	Gyro = Gyroscope
o	Mag = Magnitude 
o	mean() = MEAN
o	std() = SD 
o	activity = ActivityName
o	code = ActivityNum
so for example we have the following changes to variable names:
o	'tBodyAcc-mean()-X' has been changed to 'TimeBodyAccelerometer -MEAN-X'
o	'tBodyAcc-std()-Z' has been changed to 'TimeBodyAccelerometer -SD-Z'
o	tBodyGyroJerk-std()-Y has been changed to ‘TimeBodyGyroscopeJerk-SD-Y’
o	‘tBodyAccJerkMag-std()’ has been changed to ‘TimeBodyAccelerometerJerkMagnitude-SD’
o	Etc…
...
•	Imports activity and label names datasets
